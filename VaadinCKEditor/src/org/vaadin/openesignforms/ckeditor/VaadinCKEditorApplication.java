...
public class VaadinCKEditorApplication extends Application
{
    ...
    public void init()
    {
        ...
        /*
         * This is the full list as we know it in CKEditor 4.x [ { name: 'document', items : [
         * 'Source','-','NewPage','Preview','Print','-','Templates' ] }, { name: 'clipboard', items : [
         * 'Cut','Copy','Paste','PasteText','PasteFromWord','-','Undo','Redo' ] }, { name: 'editing', items : [
         * 'Find','Replace','-','SelectAll','-','SpellChecker', 'Scayt' ] }, { name: 'forms', items : [ 'Form',
         * 'Checkbox', 'Radio', 'TextField', 'Textarea', 'Select', 'Button', 'ImageButton', 'HiddenField' ] }, '/', {
         * name: 'basicstyles', items : [
         * 'Bold','Italic','Underline','Strike','Subscript','Superscript','-','RemoveFormat' ] }, { name: 'paragraph',
         * items : [
         * 'NumberedList','BulletedList','-','Outdent','Indent','-','Blockquote','CreateDiv','-','JustifyLeft','
         * JustifyCenter','JustifyRight','JustifyBlock','-','BidiLtr','BidiRtl' ] }, { name: 'links', items : [
         * 'Link','Unlink','Anchor' ] }, { name: 'insert', items : [
         * 'Image','Flash','Table','HorizontalRule','Smiley','SpecialChar','PageBreak','Iframe' ] }, '/', { name:
         * 'styles', items : [ 'Styles','Format','Font','FontSize' ] }, { name: 'colors', items : [
         * 'TextColor','BGColor' ] }, { name: 'tools', items : [ 'Maximize', 'ShowBlocks','-','About' ] } ]
         */
        ...
        ckEditorTextField1.addListener(new Property.ValueChangeListener()
        {
            ...
            {
                getMainWindow().showNotification("CKEditor v" + ckEditorTextField1.getVersion() + "/" + getVersion()
                    + " - #1 contents: " + event.getProperty().toString().replaceAll("<", "&lt;"));
        ...
        ckEditorTextField2.addListener(new Property.ValueChangeListener()
        {
            ...
            public void valueChange(final ValueChangeEvent event)
            {
                getMainWindow().showNotification("CKEditor v" + ckEditorTextField2.getVersion() + "/" + getVersion()
                    + " - #2 contents: " + event.getProperty().toString().replaceAll("<", "&lt;"));
            }
        });
        ...
        mainWindow.addComponent(new Button("Open Modal Subwindow", new ClickListener()
        {
            ...
            public void buttonClick(final ClickEvent event)
            {
                ...
                ckEditorTextField.addListener(new Property.ValueChangeListener()
                {
                    ...
                    {
                        getMainWindow()
                            .showNotification("CKEditor v" + ckEditorTextField2.getVersion() + "/" + getVersion()
                                + " - POPUP MODAL contents: " + event.getProperty().toString().replaceAll("<", "&lt;"));
                    }
                });
        ...
        mainWindow.addComponent(new Button("Open Non-Modal Subwindow with 100% Height", new ClickListener()
        {
            ...
            public void buttonClick(final ClickEvent event)
            {
                ...
                ckEditorTextField.addListener(new Property.ValueChangeListener()
                {
                    ...
                    public void valueChange(final ValueChangeEvent event)
                    {
                        getMainWindow().showNotification("CKEditor v" + ckEditorTextField2.getVersion() + "/"
                            + getVersion() + " - POPUP NON-MODAL 100% HEIGHT contents: "
                            + event.getProperty().toString().replaceAll("<", "&lt;"));
                    }
                });
                ...
                textField.addListener(new Property.ValueChangeListener()
                {
                    ...
                    public void valueChange(final ValueChangeEvent event)
                    {
                        getMainWindow().showNotification(
                            "TextField - POPUP NON-MODAL 100% HEIGHT contents: " + event.getProperty().toString());
                    }
                });
